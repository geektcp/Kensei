Kensei
========================================
Kensei is a hack tool for WoW client, support Classic, TBC, Wotlk
<br/>
剑圣是服务于魔兽世界的国产高科技产品，对标并超越旅行者，加特林等国外产品。
<br/>
轻量安全，放心使用。持续更新，后续版本将支持1.12，2.43，3.33，3.32，3.35等资料片对应的客户端版本。
<br/>

## 版本
```
Kensei-1.1
读取角色信息，进程自动识别，手动识别，搜索名称，指定进程id都可以选中进程。
